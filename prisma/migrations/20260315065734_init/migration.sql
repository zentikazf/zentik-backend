...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('TASK_ASSIGNED', 'TASK_UPDATED', 'TASK_COMPLETED', 'COMMENT_ADDED', 'MENTION', 'SPRINT_STARTED', 'SPRINT_COMPLETED', 'INVOICE_CREATED', 'INVOICE_PAID', 'MEMBER_JOINED', 'MEMBER_REMOVED', 'PROJECT_CREATED', 'PROJECT_ARCHIVED');
